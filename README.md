...
Maven中央仓库地址:<https://mvnrepository.com/artifact/com.alibaba/druid>

GitHub:<https://github.com/alibaba/druid>

>测试环境:
 Maven4.0、SpringBoot2.0.5.RELEASE、JDK1.8
...
```
配置类写完后通过访问 ` localhost:8080/druid/index.html` 进入监控页面
